...
const Footer = () => {
    ...
    return (
        <div className="bg-pastel-orange" style={{height: "300px"}}>
            <Button id="BackToTopBtn" type="primary" icon={<ArrowUpOutlined/>} onClick={topFunction}>Back to
                Top</Button>
                ...
                <Row>
                    ...
                    <Col xs={4}>
                        <Container>
                            ...
                            <Row><Col><MailFilled/><a className="footer-link" style={{marginLeft: "5px"}}
                                                      href="mailto:thamidaulay@gmail.com" target="_blank"
                                                      rel="noreferrer noopener" title="Email">thamidaulay@gmail.com</a></Col></Row>
                            <Row><Col><LinkedinFilled/><a className="footer-link" style={{marginLeft: "5px"}}
                                                          href="https://www.linkedin.com/in/thami-endamora/"
                                                          target="_blank" rel="noreferrer noopener"
                                                          title="Linkedin">linkedin.com/in/thami-endamora</a></Col></Row>
                        </Container>
                    </Col>
                </Row>
            </Container>
