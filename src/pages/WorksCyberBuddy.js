                            ...
                            <Col style={{maxWidth: "660px"}}>
                                <Container className="bg-pastel-orange py-5 px-5 border-radius-30">
                                    ...
                                    <Row><Col><p className="size-15-text mb-0">Children can minimize cyberbullying
                                        ...
                                        when sending messages.</p></Col></Row>
                                </Container>
                            </Col>
                        </Row>
                    ...
                    <Container style={{boxShadow: "rgba(99, 99, 99, 0.2) 0px 2px 8px 0px", maxWidth: "1150px"}}
                        ...
                        <Row>
                            <Col xs={4} className="justify-content-center text-center">
                                <Image width={318} preview={false}
                                       src="https://live.staticflickr.com/65535/52551045979_a09bb17ce2_o.png"/>
                            </Col>
                            <Col>
                                <Container className="py-4">
                                    ...
                                    <Row>
                                        <Col xs={5}>
                                            <Container>
                                                <Row>
                                                    <Col xs={1} className="px-0"><Image width={15} preview={false}
                                                                                        src="https://live.staticflickr.com/65535/52551231350_fea669f52d_o.png"/></Col>
                                                    <Col className="size-15-text px-0">10 years old</Col>
                                                </Row>
                                                <Row>
                                                    <Col xs={1} className="px-0"><Image width={15} preview={false}
                                                                                        src="https://live.staticflickr.com/65535/52550305302_6fc31e818d_o.png"/></Col>
                                                    <Col className="size-15-text px-0">Year 5</Col>
                                                </Row>
                                                <Row>
                                                    <Col xs={1} className="px-0"><Image width={15} preview={false}
                                                                                        src="https://live.staticflickr.com/65535/52550758256_70dc11178e_o.png"/></Col>
                                    ...
                                    <Row style={{marginTop: "35px"}}>
                                        <Col xs={5}>
                                            ...
                                            <Container>
                                                <Row>
                                                    <Col className="size-15-text px-0" style={{marginRight: "10px"}}>Academic
                                                        purposes</Col>
                                                    <Col className="px-0 flex-width-s">
                                                        <div className="circle-12-size bg-orange"/>
                                                    </Col>
                                                    <Col className="px-0 flex-width-s">
                                                        <div className="circle-12-size bg-orange"/>
                                                    </Col>
                                            ...
                                            <Container>
                                                <Row>
                                                    <Col className="size-15-text px-0" style={{marginRight: "10px"}}>Play
                                                        video games</Col>
                                                    <Col className="px-0 flex-width-s">
                                                        <div className="circle-12-size bg-orange"/>
                                                    </Col>
                                                    <Col className="px-0 flex-width-s">
                                                        <div className="circle-12-size bg-darkgrey"/>
                                                    </Col>
                                                    <Col className="px-0 flex-width-s">
                                                        <div className="circle-12-size bg-darkgrey"/>
                                                    </Col>
                                            ...
                                            <Container>
                                                <Row>
                                                    <Col className="size-15-text px-0" style={{marginRight: "10px"}}>Use
                                                        social media</Col>
                                                    <Col className="px-0 flex-width-s">
                                                        <div className="circle-12-size bg-orange"/>
                                                    </Col>
                                        ...
                                        <Col xs={5} style={{marginLeft: "65px"}}>
                                            ...
                                            <Container style={{maxWidth: "200px"}} className="mx-0">
                                                <Row className="justify-content-center text-center">
                                                    <Col><Image width={34} preview={false}
                                                                src="https://live.staticflickr.com/65535/52550309882_923e2cf2c6_o.png"/></Col>
                                                    <Col><Image width={34} preview={false}
                                                                src="https://live.staticflickr.com/65535/52551058539_83f69b3fd5_o.png"/></Col>
                                                    <Col><Image width={34} preview={false}
                                                                src="https://live.staticflickr.com/65535/52550763091_0f71317ecc_o.png"/></Col>
                                                </Row>
                                            </Container>
                                        </Col>
                                    </Row>
                                    <Row style={{marginTop: "15px"}}>
                                        ...
                                        <Col xs={5} style={{marginLeft: "65px"}}>
                                            ...
                                            <Container style={{maxWidth: "200px"}} className="mx-0">
                                                <Row className="justify-content-center text-center">
                                                    <Col><Image width={34} preview={false}
                                                                src="https://live.staticflickr.com/65535/52551734442_8e6fc1dd29_o.png"/></Col>
                                                    <Col><Image width={34} preview={false}
                                                                src="https://live.staticflickr.com/65535/52552736953_c1f73aefdb_o.png"/></Col>
                                                    <Col><Image width={34} preview={false}
                                                                src="https://live.staticflickr.com/65535/52552736968_5c9ee88bac_o.png"/></Col>
                                                </Row>
                                            </Container>
                                        </Col>
                                    </Row>
                ...
                <Col>
                    ...
                    <Container style={{maxWidth: "650px"}} className="my-5">
                        ...
                        <Row className="my-3">
                            <Col>
                                <Container className="bg-pastel-orange py-4 px-5 border-radius-20">
                                    <Row><Col className="size-15-text mb-0">Children's favourite game genre:
                                        Simulation</Col></Row>
                                </Container>
                            </Col>
                            <Col>
                        ...
                        <Row className="my-3">
                            <Col>
                                <Container className="bg-pastel-orange py-4 px-5 border-radius-20">
                                    <Row><Col className="size-15-text mb-0">Children love games with clear goals or
                                        missions</Col></Row>
                                </Container>
                            </Col>
                            <Col>
                                <Container className="bg-pastel-orange py-4 px-5 border-radius-20">
                                    <Row><Col className="size-15-text mb-0"
                                              style={{paddingTop: "0.75rem", paddingBottom: "0.75rem"}}>Avatar happiness
                                        meter</Col></Row>
                                </Container>
                            </Col>
                        </Row>
                        <Row className="my-3">
                            <Col>
                                <Container className="px-0">
                                    <Row>
                                        <Col>
                                            <Container className="bg-pastel-orange py-4 px-5 border-radius-20">
                                                <Row><Col className="size-15-text mb-0">Children would like to customize
                                                    their game character's appearance</Col></Row>
                                            </Container>
                                        </Col>
                                    </Row>
                                    <Row style={{marginTop: "1rem"}}>
                                        <Col>
                                            <Container className="bg-pastel-orange py-4 px-5 border-radius-20">
                                                <Row><Col className="size-15-text mb-0">Children would like to collect
                                                    in-game currency and buy things/powerups</Col></Row>
                                            </Container>
                                        </Col>
                                    </Row>
                                </Container>
                            ...
                            <Col>
                                <Container className="bg-pastel-orange py-4 px-5 border-radius-20">
                                    <Row><Col className="size-15-text mb-0"
                                              style={{paddingTop: "5.75rem", paddingBottom: "5.75rem"}}>Avatar Creator
                                        app</Col></Row>
                                </Container>
                            </Col>
                        </Row>
                        <Row className="my-3">
                            <Col>
                                <Container className="bg-pastel-orange py-4 px-5 border-radius-20">
                                    <Row><Col className="size-15-text mb-0"
                                              style={{paddingTop: "0.75rem", paddingBottom: "0.75rem"}}>Learning
                                        goals</Col></Row>
                                </Container>
                            </Col>
                            <Col>
                                <Container className="bg-pastel-orange py-4 px-5 border-radius-20">
                                    <Row><Col className="size-15-text mb-0">Cyberbullying simulation
                                        scenario</Col></Row>
                                </Container>
                            </Col>
                        </Row>
                ...
                <Col>
                    ...
                    <Container>
                        <Row className="text-center justify-content-center">
                            <Image.PreviewGroup>
                                <Col className="flex-width-m px-0"><Image width={299}
                                                                          src="https://live.staticflickr.com/65535/52551834792_6196be204e_o.png"/></Col>
                                <Col className="flex-width-xxs px-2 flex-align-center"><Image width={30} preview={false}
                                                                                              src="https://live.staticflickr.com/65535/52551838527_0729cd82b2_o.png"/></Col>
                                <Col className="flex-width-m px-0"><Image width={299}
                                                                          src="https://live.staticflickr.com/65535/52552295321_99745322d3_o.png"/></Col>
                                <Col className="flex-width-xxs px-2 flex-align-center"><Image width={30} preview={false}
                                                                                              src="https://live.staticflickr.com/65535/52551838527_0729cd82b2_o.png"/></Col>
                                <Col className="flex-width-m px-0"><Image width={299}
                                                                          src="https://live.staticflickr.com/65535/52552765380_537bb606e0_o.png"/></Col>
                                <Col className="flex-width-xxs px-2 flex-align-center"><Image width={30} preview={false}
                                                                                              src="https://live.staticflickr.com/65535/52551838527_0729cd82b2_o.png"/></Col>
                                <Col className="flex-width-m px-0"><Image width={299}
                                                                          src="https://live.staticflickr.com/65535/52552765380_537bb606e0_o.png"/></Col>
                        ...
                        <Row className="text-center justify-content-center">
                            <Col className="flex-width-m px-0"><p className="size-15-text mb-0">Low-fidelity
                                Prototype</p></Col>
                            <Col className="flex-width-xxs px-2 flex-align-center"/>
                            <Col className="flex-width-m px-0"><p className="size-15-text mb-0">Medium-fidelity
                                Prototype</p></Col>
                            <Col className="flex-width-xxs px-2 flex-align-center"/>
                            <Col className="flex-width-m px-0"><p className="size-15-text mb-0">High-fidelity
                                Prototype</p></Col>
                            <Col className="flex-width-xxs px-2 flex-align-center"/>
                            <Col className="flex-width-m px-0"><p className="size-15-text mb-0">Final
                                Prototype <br></br>(Fully-programmed & functional)</p></Col>
                        </Row>
                    </Container>
                    ...
                    <Container className="px-0">
                        ...
                        <Row className="mt-5">
                            <Col>
                                <Container className="bg-pastel-orange mt-4 px-5 py-4">
                                    ...
                                    <Row className="mt-3">
                                        <Col className="size-15-text mb-0">Experts emphasize the importance of <span
                                            className="semibold-text">providing direct feedback on the actions taken</span> in
                                            games, such as "good job!" to motivate children to do good things. So after
                                            the player chooses an answer, the screen will display a feedback panel
                                            consisting of a brief explanation of why the action is appropriate or
                                            inappropriate. Example on Playbox app:</Col>
                                    </Row>
                                </Container>
                            </Col>
                        </Row>
                        <Row className="mt-5 justify-content-center">
                            <Container className="px-5">
                                <Image.PreviewGroup>
                                    <Row className="text-center">
                                        <Col><Image width={268}
                                                    src="https://live.staticflickr.com/65535/52554300278_7e5d7f28df_o.png"/></Col>
                                        <Col xs={1}
                                             className="flex-align-center justify-content-center text-center"><Image
                                            width={50} preview={false}
                                            src="https://live.staticflickr.com/65535/52553776956_acb3bc2b8b_o.png"/></Col>
                                        <Col><Image width={268}
                                                    src="https://live.staticflickr.com/65535/52553762726_e0832a9555_o.png"/></Col>
                                        <Col xs={1}
                                             className="flex-align-center justify-content-center text-center"><Image
                                            width={50} preview={false}
                                            src="https://live.staticflickr.com/65535/52553776956_acb3bc2b8b_o.png"/></Col>
                                        <Col><Image width={268}
                                                    src="https://live.staticflickr.com/65535/52553303362_b859f8826a_o.png"/></Col>
                                        <Col></Col>
                                    </Row>
                                    <Row className="justify-content-center mt-2">
                                        <Col xs={3} style={{paddingRight: 0}}><p className="size-15-text mb-0">Loading
                                            scene represents the player <br></br>is playing a multiplayer game with a
                                            friend.</p></Col>
                                        <Col xs={1} className="flex-width-xs px-0"/>
                                        <Col xs={3} className="px-0" style={{marginLeft: "30px"}}><p
                                            className="size-15-text mb-0">Shows a scenario where the player <br></br>lose
                                            to their friend and must choose <br></br>a message to send.</p></Col>
                                        <Col xs={1} className="flex-width-xs px-0"/>
                                        <Col xs={3} className="px-0" style={{marginLeft: "22px"}}><p
                                            className="size-15-text mb-0">Shows the message sent and their friend's
                                            reply to the player.</p></Col>
                                        <Col></Col>
                                    </Row>
                                    <Row className="mt-1">
                                        <Col xs={8}></Col>
                                        <Col><Image width={180} preview={false}
                                                    src="https://live.staticflickr.com/65535/52553337642_c103cd9531_o.png"/></Col>
                                    </Row>
                                    <Row className="mt-4">
                                        <Col xs={6}></Col>
                                        <Col><Image width={268}
                                                    src="https://live.staticflickr.com/65535/52554300293_eeca367265_o.png"/></Col>
                                        <Col><Image width={268}
                                                    src="https://live.staticflickr.com/65535/52554235320_8964473670_o.png"/></Col>
                                        <Col xs={1}></Col>
                                    </Row>
                                    <Row className="justify-content-center mt-2">
                                        <Col></Col>
                                        <Col xs={3} style={{paddingLeft: "12px", paddingRight: 0}}><p
                                            className="size-15-text mb-0">Shows an appreciation if the player choose to
                                            congratulate their friend.</p></Col>
                                        <Col xs={3} style={{paddingLeft: "10px", paddingRight: 0}}><p
                                            className="size-15-text mb-0">Shows an encouragement to choose better next
                                            time if the player insult <br></br>their friend.</p></Col>
                                    </Row>
                                </Image.PreviewGroup>
                            </Container>
                        </Row>
                        ...
                        <Row className="mt-5">
                            <Col>
                                <Container className="bg-pastel-orange mt-4 px-5 py-4">
                                    ...
                                    <Row className="mt-3">
                                        <Col className="size-15-text mb-0">In this app, players can change the avatar's
                                            name and appearance. This application refers to the user's preferred game
                                            characteristics, which is the <span className="semibold-text">customization feature</span>.
                                            The mechanism for collecting points and opening new options represented the
                                            currency and shopping activity.</Col>
                                    </Row>
                                </Container>
                            </Col>
                        </Row>
                        <Row className="mt-4 justify-content-center">
                            <Container className="px-5">
                                <Image.PreviewGroup>
                                    <Row className="text-center">
                                        <Col xs={4}><Image width={410}
                                                           src="https://live.staticflickr.com/65535/52554220919_a7f4c0d127_o.png"/></Col>
                                        <Col xs={4}><Image width={410}
                                                           src="https://live.staticflickr.com/65535/52553469477_5340983330_o.png"/></Col>
                                        <Col xs={4}><Image width={410}
                                                           src="https://live.staticflickr.com/65535/52554466118_9caf4b7cf2_o.png"/></Col>
                                    </Row>
                                    <Row className="mt-2"><Col className="size-15-text">At the start of the game, some
                                        options are still locked and players need to <span className="semibold-text">collect points</span> to
                                        unlock these options. The avatar design is stylized to be moderately
                                        cartoon-like and cute baby-like to promote positive emotional experiences, such
                                        as honesty and innocence, compared to realistically drawn avatars
                                        [2].</Col></Row>
                                    <Row className="mt-3"><Col className="size-12-text darkgrey-text-color">[2] K.
                                        Segaran, A. Z. M. Ali, T. W. Hoe, “Does avatar design in educational games
                                        promote a positive emotional experience among learners?,” E-Learning and Digital
                                        Media, vol. 18, no. 5, pp. 422–440, 2021.</Col></Row>
                                </Image.PreviewGroup>
                            </Container>
                        </Row>
                        ...
                        <Row className="mt-5">
                            <Col>
                                <Container className="bg-pastel-orange mt-4 px-5 py-4">
                                    ...
                                    <Row className="mt-3">
                                        <Col className="size-15-text mb-0">There are three end-game conditions designed:
                                            the player <span className="semibold-text">wins, loses, and chooses to stop playing</span>.
                                            The player wins when they successfully collect points until the avatar's
                                            happiness level arrow reaches the far right. The player loses if they have
                                            not accumulated enough points and have passed the play duration limit. The
                                            last condition is when the player presses the "Stop Playing" button on Main
                                            Menu.</Col>
                                    </Row>
                                </Container>
                            </Col>
                        ...
                        <Row className="mt-3 justify-content-center">
                            <Container className="px-5">
                                <Image.PreviewGroup>
                                    <Row className="text-center">
                                        <Col xs={4}><Image width={410}
                                                           src="https://live.staticflickr.com/65535/52553479487_40c05cba16_o.png"/></Col>
                                        <Col xs={4}><Image width={410}
                                                           src="https://live.staticflickr.com/65535/52553938586_b1fab1ef43_o.png"/></Col>
                                        <Col xs={4}><Image width={410}
                                                           src="https://live.staticflickr.com/65535/52554410065_4f348ca688_o.png"/></Col>
                                    </Row>
                                    <Row>
                                        <Col xs={4} className="size-15-text" style={{paddingLeft: "27px"}}>Congratulate
                                            the player if they win and encourage them to implement the knowledge and be
                                            a good friend in the real world.</Col>
                                        <Col xs={4} className="size-15-text" style={{paddingLeft: "40px"}}>Encourage the
                                            player to play again next time if they lose and cheer them up, saying they
                                            still <br></br>can be a good friend in the real world.</Col>
                                        <Col xs={4} className="size-15-text" style={{paddingLeft: "50px"}}>Express
                                            appreciation to the player for playing the game if the player chooses to
                                            quit.</Col>
                                    </Row>
                                </Image.PreviewGroup>
                            </Container>
                            ...
                            <Image.PreviewGroup>
                                <Row className="text-center my-4">
                                    <Container style={{maxWidth: "1000px"}}>
                                        <Row>
                                            <Col><Image width={240}
                                                        src="https://live.staticflickr.com/65535/52553955841_06d51d2bc5_o.png"/></Col>
                                            <Col xs={1}
                                                 className="flex-align-center justify-content-center text-center"><Image
                                                width={50} preview={false}
                                                src="https://live.staticflickr.com/65535/52553776956_acb3bc2b8b_o.png"/></Col>
                                            <Col><Image width={240}
                                                        src="https://live.staticflickr.com/65535/52553496682_86666c5cc1_o.png"/></Col>
                                            <Col xs={1}
                                                 className="flex-align-center justify-content-center text-center"><Image
                                                width={50} preview={false}
                                                src="https://live.staticflickr.com/65535/52553776956_acb3bc2b8b_o.png"/></Col>
                                            <Col><Image width={240}
                                                        src="https://live.staticflickr.com/65535/52553955866_e96a560c21_o.png"/></Col>
                                        </Row>
                                    </Container>
                                </Row>
                            </Image.PreviewGroup>
                            <Row><Col className="size-15-text">The logo is orange-yellow-ish coloured and uses <span
                                className="fredoka-font">Fredoka One</span> font (a bold rounded font) to reflect Cyber
                                Buddy's friendly, energizing, and cheerful personality.</Col></Row>
                        </Container>
                        <Container style={{boxShadow: "rgba(99, 99, 99, 0.2) 0px 2px 8px 0px", maxWidth: "1150px"}}
                            ...
                            <Row className="mt-4">
                                <Col>
                                    <Container className="px-0">
                                        <Row><Col><h2 className="poppins-font mb-0 bold-text"
                                                      style={{fontSize: "30px"}}>Header, App Name</h2></Col></Row>
                                        <Row><Col><p className="mb-0 darkgrey-text-color">Poppins Bold 33pt</p>
                                        </Col></Row>
                                        <Row className="mt-4"><Col><h5 className="poppins-font mb-0 semibold-text"
                                                                       style={{fontSize: "18px"}}>Subheader, Main Menu
                                            Buttons</h5></Col></Row>
                                        <Row><Col><p className="mb-0 darkgrey-text-color">Poppins Semibold 18pt</p>
                                        </Col></Row>
                                        ...
                                        <Row>
                                            <Col>
                                                <Container className="px-0">
                                                    <Row>
                                                        <Col>
                                                            <div className="color-palette-square"
                                                                 style={{backgroundColor: "#F8EA69"}}/>
                                                        </Col>
                                                        <Col>
                                                            <div className="color-palette-square"
                                                                 style={{backgroundColor: "#57C3DB"}}/>
                                                        </Col>
                                                        <Col>
                                                            <div className="color-palette-square"
                                                    ...
                                                    <Row className="mt-4">
                                                        <Col>
                                                            <div className="color-palette-square"
                                                                 style={{backgroundColor: "#4DBD66"}}/>
                                                        </Col>
                                                        <Col>
                                                            <div className="color-palette-square"
                                                                 style={{backgroundColor: "#EA6481"}}/>
                                                        </Col>
                                                        <Col>
                                                            <div className="color-palette-square"
                                                                 style={{backgroundColor: "#996ACC"}}/>
                                                        </Col>
                                                    </Row>
                                                    <Row>
                                            ...
                                            <Col className="size-15-text">The “Poppins” font and the colorful color
                                                palette are used in the whole game to reflect Cyber Buddy's friendly,
                                                inviting, and lively personality.</Col>
                                        </Row>
                                    </Container>
                                </Col>
                            </Row>
